  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        {/* ========================================
            EMPTY STATE (shared by table + cards)
        ========================================= */}
        ...
        {filteredReports.length === 0 ? (
          ...
          <>
            ...
            {/* ========================================
                ...
                Hidden on mobile, shown from md breakpoint up
            ========================================= */}
            ...
            {/* ========================================
                ...
                Shown only below md breakpoint
            ========================================= */}
              ...
              {filteredReports.map((report) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="mt-4 w-full inline-flex items-center justify-center gap-2 px-3 py-2.5 rounded-lg bg-slate-900 hover:bg-slate-800 text-white text-sm font-semibold transition"
                  >
